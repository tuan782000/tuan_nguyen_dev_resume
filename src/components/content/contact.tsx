            ...
            <div className="arlo_tm_section" id="contact">
                ...
                <div className="arlo_tm_footer_contact_wrapper_all">
                                    ...
                                    <ul>
                                        <li>
                                            <p>
                                                <label>Email:</label>
                                                <span>
                                                    <a href="mailto:thaituan7820@gmail.com">
                                        ...
                                        <li>
                                            <p>
                                                <label>Github:</label>
                                                <span>
                                                    <a href="https://github.com/tuan782000" target="_blank">
                                                        tuan782000
                                                    </a>
                                                </span>
                                            </p>
                    ...
                    <div className="arlo_tm_footer_wrap">
                        <div className="container">
                            <p>
                                &copy; Copyright 2023 by Tuan Nguyen. All Rights are Reserved.
                            </p>
                        </div>
                    </div>
                </div>
